...
export const translations = {
  en: {
    ...
    galvao_cta_about: 'Learn More',
    galvao_about_title: 'Who is André Galvão',
    galvao_about_text: 'Known worldwide for his technical excellence, competitive success, and influence as co-founder and head coach of Atos Jiu-Jitsu, André Galvão has built an extraordinary legacy in both Brazilian Jiu-Jitsu and submission grappling. For the first time ever, he brings his seminar to the Netherlands, hosted by Best of the Best BJJ.',
    galvao_career_title: 'Career Highlights',
    galvao_career_text: 'His career highlights include winning both the ADCC -88 kg Division and Absolute Division in 2011, followed by an unprecedented run of four ADCC Superfight victories in 2013, 2015, 2017 and 2019. He has also won multiple IBJJF World and Pan Championships, as well as multiple Abu Dhabi World Professional titles.',
  ...
  nl: {
    ...
    galvao_cta_about: 'Meer Weten',
    galvao_about_title: 'Wie is André Galvão',
    galvao_about_text: 'Wereldwijd bekend om zijn technische meesterschap, wedstrijdsucces en invloed als medeoprichter en hoofdtrainer van Atos Jiu-Jitsu, heeft André Galvão een buitengewone legacy opgebouwd binnen zowel Braziliaans Jiu-Jitsu als submission grappling. Voor het eerst ooit brengt hij zijn seminar naar Nederland, georganiseerd door Best of the Best BJJ.',
    galvao_career_title: 'Carrièrehoogtepunten',
    galvao_career_text: 'Zijn carrièrehoogtepunten omvatten het winnen van zowel de ADCC -88 kg divisie als de Absolute divisie in 2011, gevolgd door een ongekende reeks van vier ADCC Superfight-overwinningen in 2013, 2015, 2017 en 2019. Daarnaast won hij meerdere IBJJF World- en Pan-titels, evenals meerdere Abu Dhabi World Professional-titels.',
  ...
  fr: {
    ...
    galvao_cta_about: 'En Savoir Plus',
    galvao_about_title: 'Qui est André Galvão',
    galvao_about_text: 'Connu dans le monde entier pour son excellence technique, son succès en compétition et son influence en tant que cofondateur et entraîneur en chef d\'Atos Jiu-Jitsu, André Galvão a bâti un héritage extraordinaire dans le Jiu-Jitsu brésilien et le submission grappling. Pour la première fois, il organise son séminaire aux Pays-Bas, présenté par Best of the Best BJJ.',
    galvao_career_title: 'Faits Marquants de Carrière',
    galvao_career_text: 'Parmi ses faits marquants de carrière : la victoire dans les catégories ADCC -88 kg et Absolue en 2011, suivie d\'une série inédite de quatre victoires en Superfight ADCC en 2013, 2015, 2017 et 2019. Il a également remporté plusieurs titres mondiaux et Pan IBJJF, ainsi que plusieurs titres Abu Dhabi World Professional.',
  ...
  de: {
    ...
    galvao_cta_about: 'Mehr Erfahren',
    galvao_about_title: 'Wer ist André Galvão',
    galvao_about_text: 'André Galvão ist weltweit bekannt für seine technische Exzellenz, seinen Wettkampferfolg und seinen Einfluss als Mitbegründer und Cheftrainer von Atos Jiu-Jitsu und hat ein außergewöhnliches Vermächtnis im Brazilian Jiu-Jitsu und Submission Grappling aufgebaut. Zum ersten Mal bringt er sein Seminar in die Niederlande, veranstaltet von Best of the Best BJJ.',
    galvao_career_title: 'Karriere-Highlights',
    galvao_career_text: 'Zu seinen Karrierehöhepunkten zählen die Siege in der ADCC -88 kg Division und der Absolute Division 2011, gefolgt von einer beispiellosen Serie von vier ADCC-Superfight-Siegen 2013, 2015, 2017 und 2019. Außerdem gewann er mehrere IBJJF World- und Pan-Titel sowie mehrere Abu Dhabi World Professional-Titel.',

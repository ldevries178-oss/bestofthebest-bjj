...
export const translations = {
  en: {
    ...
    // Vertical Nav
    navGalvao: 'André Galvão — November 28, 2026',
    ...
    // André Galvão Seminar Page
    galvao_kicker: 'BEST OF THE BEST BJJ PRESENTS',
    galvao_title: 'ANDRÉ GALVÃO',
    galvao_hero_subtitle: 'A BJJ legend is coming to the Netherlands for the first time ever.',
    galvao_date_label: 'Date',
    galvao_date_value: '28 November 2026',
    galvao_location_label: 'Location',
    galvao_location_value: 'Topsportcentrum Almere',
    galvao_cta_tickets: 'Get Tickets',
    galvao_cta_faq: 'FAQ',
    galvao_about_title: 'André Galvão — A Legacy That Speaks for Itself',
    galvao_about_text: 'Prof. André Galvão is widely regarded as one of the greatest Brazilian Jiu-Jitsu and submission grappling athletes of all time. A multiple-time world champion and ADCC legend, he has earned global respect for his elite technique, explosive style, and championship mentality.\n\nAs co-founder and head coach of Atos Jiu-Jitsu, Galvão has also helped shape some of the best competitors in the world.\n\nA world-class champion, elite coach, and true legend of Brazilian Jiu-Jitsu.',
    galvao_career_title: 'The Greatest Jiu-Jitsu Competitor of All Time',
    galvao_career_text: 'Prof. André Galvão is one of the greatest Brazilian Jiu-Jitsu athletes and coaches of all time, winning numerous championship titles over his 26-year career in the sport, and leading his team to win World, No-Gi World, Pan American and Kid\'s Pan titles. He is a dedicated father and husband, whose faith in God has helped guide him in his personal and public achievements, and in becoming one of the legends of the sport of jiu-jitsu.',
    galvao_titles_heading: 'Major Titles',
    galvao_major_title_1: '6x ADCC World Champion',
    galvao_major_title_2: '6x IBJJF World Champion',
    galvao_major_title_3: '9x IBJJF Pan American Champion',
    galvao_major_title_4: '3x UAEJJF World Pro Champion',
    galvao_major_title_5: '2x IBJJF European Champion',
    galvao_format_title: 'What to Expect',
    galvao_format_main: 'One-hour Main No-Gi Seminar with André Galvão',
    galvao_format_masters: 'Exclusive Masters Session — limited spots, closed small-group setting',
    galvao_tickets_title: 'Tickets',
    galvao_tickets_presale_title: 'Ticket sales open soon',
    galvao_tickets_presale_text: 'Ticket sales start Monday, 5 October 2026. Check back here to secure your spot.',
    galvao_tickets_open_text: 'Tickets are on sale now via Weeztix.',
    galvao_tickets_provider: 'Tickets via Weeztix',
    galvao_sponsors_title: 'Sponsors',
    galvao_sponsors_placeholder: 'Sponsors will be announced soon.',
    galvao_media_title: 'Media Partners',
    galvao_media_placeholder: 'Media partners will be announced soon.',
  ...
  nl: {
    ...
    // Vertical Nav
    navGalvao: 'André Galvão — 28 november 2026',
    ...
    galvao_title: 'ANDRÉ GALVÃO',
    galvao_hero_subtitle: 'Een BJJ-legende komt voor het eerst ooit naar Nederland.',
    galvao_date_label: 'Datum',
    galvao_date_value: '28 november 2026',
    galvao_location_label: 'Locatie',
    galvao_location_value: 'Topsportcentrum Almere',
    galvao_cta_tickets: 'Bestel Tickets',
    galvao_cta_faq: 'Veelgestelde Vragen',
    galvao_about_title: 'André Galvão — Een Legacy Die Voor Zich Spreekt',
    galvao_about_text: 'Prof. André Galvão wordt wereldwijd beschouwd als een van de grootste Braziliaans Jiu-Jitsu- en submission grappling-atleten aller tijden. Als meervoudig wereldkampioen en ADCC-legende heeft hij wereldwijd respect verdiend om zijn uitmuntende techniek, explosieve stijl en kampioensmentaliteit.\n\nAls medeoprichter en hoofdtrainer van Atos Jiu-Jitsu heeft Galvão ook bijgedragen aan het vormen van enkele van de beste atleten ter wereld.\n\nEen wereldklasse kampioen, topcoach en ware legende van het Braziliaans Jiu-Jitsu.',
    galvao_career_title: 'De Grootste Jiu-Jitsu Competitor Aller Tijden',
    galvao_career_text: 'Prof. André Galvão is een van de grootste Braziliaans Jiu-Jitsu-atleten en -trainers aller tijden. In zijn 26-jarige carrière won hij talloze kampioenstitels en leidde hij zijn team naar World-, No-Gi World-, Pan American- en Kid\'s Pan-titels. Hij is een toegewijde vader en echtgenoot, wiens geloof in God hem heeft geholpen bij zijn persoonlijke en publieke prestaties en bij het uitgroeien tot een van de legendes van de jiu-jitsusport.',
    galvao_titles_heading: 'Belangrijkste Titels',
    galvao_major_title_1: '6x ADCC Wereldkampioen',
    galvao_major_title_2: '6x IBJJF Wereldkampioen',
    galvao_major_title_3: '9x IBJJF Pan American Champion',
    galvao_major_title_4: '3x UAEJJF World Pro Champion',
    galvao_major_title_5: '2x IBJJF Europees Kampioen',
    galvao_format_title: 'Wat Kun Je Verwachten',
    galvao_format_main: 'Eén uur durend hoofdseminar No-Gi met André Galvão',
    galvao_format_masters: 'Exclusieve Masters Sessie — beperkt aantal plekken, besloten kleinschalige setting',
    galvao_tickets_title: 'Tickets',
    galvao_tickets_presale_title: 'Kaartverkoop start binnenkort',
    galvao_tickets_presale_text: 'De kaartverkoop start op maandag 5 oktober 2026. Kom hier terug om je plek te verzekeren.',
  ...
  fr: {
    ...
    // Vertical Nav
    navGalvao: 'André Galvão — 28 novembre 2026',
    ...
    // Page Séminaire André Galvão (FR)
    galvao_kicker: 'BEST OF THE BEST BJJ PRÉSENTE',
    galvao_title: 'ANDRÉ GALVÃO',
    galvao_hero_subtitle: 'Une légende du BJJ arrive pour la première fois aux Pays-Bas.',
    galvao_date_label: 'Date',
    galvao_date_value: '28 novembre 2026',
    galvao_location_label: 'Lieu',
    galvao_location_value: 'Topsportcentrum Almere',
    galvao_cta_tickets: 'Acheter des Billets',
    galvao_cta_faq: 'FAQ',
    galvao_about_title: 'André Galvão — Un Héritage Qui Parle de Lui-Même',
    galvao_about_text: 'Le Prof. André Galvão est largement considéré comme l\'un des plus grands athlètes de Jiu-Jitsu brésilien et de submission grappling de tous les temps. Champion du monde à plusieurs reprises et légende de l\'ADCC, il a gagné le respect mondial pour sa technique d\'élite, son style explosif et sa mentalité de champion.\n\nEn tant que cofondateur et entraîneur en chef d\'Atos Jiu-Jitsu, Galvão a également contribué à former certains des meilleurs compétiteurs au monde.\n\nUn champion de classe mondiale, un entraîneur d\'élite et une véritable légende du Jiu-Jitsu brésilien.',
    galvao_career_title: 'Le Plus Grand Compétiteur de Jiu-Jitsu de Tous les Temps',
    galvao_career_text: 'Le Prof. André Galvão est l\'un des plus grands athlètes et entraîneurs de Jiu-Jitsu brésilien de tous les temps, remportant de nombreux titres de championnat au cours de sa carrière de 26 ans dans ce sport, et menant son équipe à remporter les titres World, No-Gi World, Pan American et Kid\'s Pan. C\'est un père et un mari dévoué, dont la foi en Dieu l\'a guidé dans ses réussites personnelles et publiques, et dans son ascension au rang de légende du jiu-jitsu.',
    galvao_titles_heading: 'Titres Majeurs',
    galvao_major_title_1: '6x Champion du Monde ADCC',
    galvao_major_title_2: '6x Champion du Monde IBJJF',
    galvao_major_title_3: '9x Champion Pan-Américain IBJJF',
    galvao_major_title_4: '3x Champion World Pro UAEJJF',
    galvao_major_title_5: '2x Champion d\'Europe IBJJF',
    galvao_format_title: 'À Quoi S\'attendre',
    galvao_format_main: 'Séminaire principal No-Gi d\'une heure avec André Galvão',
    galvao_format_masters: 'Session Masters exclusive — places limitées, cadre restreint et fermé',
    galvao_tickets_title: 'Billets',
    galvao_tickets_presale_title: 'Vente de billets bientôt disponible',
    galvao_tickets_presale_text: 'La vente de billets débute le lundi 5 octobre 2026. Revenez ici pour réserver votre place.',
    galvao_tickets_open_text: 'Les billets sont désormais en vente via Weeztix.',
    galvao_tickets_provider: 'Billets via Weeztix',
    galvao_sponsors_title: 'Sponsors',
    galvao_sponsors_placeholder: 'Les sponsors seront annoncés prochainement.',
    galvao_media_title: 'Partenaires Médias',
    galvao_media_placeholder: 'Les partenaires médias seront annoncés prochainement.',
    galvao_press_title: 'Presse & Partenariats',
    galvao_press_text: 'Pour la presse, les interviews, les accréditations, les collaborations média et influenceurs, ainsi que les demandes de partenariat, contactez-nous à :',
  },
  ...
  de: {
    ...
    // André Galvão Seminar-Seite (DE)
    galvao_kicker: 'BEST OF THE BEST BJJ PRÄSENTIERT',
    galvao_title: 'ANDRÉ GALVÃO',
    galvao_hero_subtitle: 'Eine BJJ-Legende kommt zum ersten Mal in die Niederlande.',
    galvao_date_label: 'Datum',
    galvao_date_value: '28. November 2026',
    galvao_location_label: 'Ort',
    galvao_location_value: 'Topsportcentrum Almere',
    galvao_cta_tickets: 'Tickets Kaufen',
    galvao_cta_faq: 'FAQ',
    galvao_about_title: 'André Galvão — Ein Vermächtnis, Das für Sich Spricht',
    galvao_about_text: 'Prof. André Galvão gilt weithin als einer der größten Athleten des Brazilian Jiu-Jitsu und Submission Grappling aller Zeiten. Als mehrfacher Weltmeister und ADCC-Legende hat er sich weltweiten Respekt für seine erstklassige Technik, seinen explosiven Stil und seine Championsmentalität erarbeitet.\n\nAls Mitbegründer und Cheftrainer von Atos Jiu-Jitsu hat Galvão zudem einige der besten Wettkämpfer der Welt mitgeformt.\n\nEin Weltklasse-Champion, Elitetrainer und eine wahre Legende des Brazilian Jiu-Jitsu.',
    galvao_career_title: 'Der Größte Jiu-Jitsu-Wettkämpfer Aller Zeiten',
    galvao_career_text: 'Prof. André Galvão ist einer der größten Athleten und Trainer des Brazilian Jiu-Jitsu aller Zeiten. In seiner 26-jährigen Karriere gewann er zahlreiche Meistertitel und führte sein Team zu World-, No-Gi World-, Pan American- und Kid\'s Pan-Titeln. Er ist ein hingebungsvoller Vater und Ehemann, dessen Glaube an Gott ihn bei seinen persönlichen und öffentlichen Erfolgen geleitet hat und ihn zu einer der Legenden des Jiu-Jitsu-Sports werden ließ.',
    galvao_titles_heading: 'Wichtigste Titel',
    galvao_major_title_1: '6x ADCC-Weltmeister',
    galvao_major_title_2: '6x IBJJF-Weltmeister',
    galvao_major_title_3: '9x IBJJF Pan-American-Champion',
    galvao_major_title_4: '3x UAEJJF World Pro Champion',
    galvao_major_title_5: '2x IBJJF-Europameister',
    galvao_format_title: 'Was Dich Erwartet',
    galvao_format_main: 'Einstündiges Haupt-Seminar No-Gi mit André Galvão',
    galvao_format_masters: 'Exklusive Masters Session — begrenzte Plätze, geschlossene Kleingruppen-Umgebung',
    galvao_tickets_title: 'Tickets',
    galvao_tickets_presale_title: 'Ticketverkauf startet bald',
    galvao_tickets_presale_text: 'Der Ticketverkauf startet am Montag, 5. Oktober 2026. Schau hier bald wieder vorbei, um dir deinen Platz zu sichern.',
    galvao_tickets_open_text: 'Tickets sind jetzt über Weeztix erhältlich.',
    galvao_tickets_provider: 'Tickets über Weeztix',
    galvao_sponsors_title: 'Sponsoren',
    galvao_sponsors_placeholder: 'Sponsoren werden in Kürze bekannt gegeben.',
    galvao_media_title: 'Medienpartner',
    galvao_media_placeholder: 'Medienpartner werden in Kürze bekannt gegeben.',

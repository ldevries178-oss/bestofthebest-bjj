...
export const translations = {
  en: {
    ...
    galvao_about_text: 'André Galvão is one of the most decorated competitors in Brazilian Jiu-Jitsu history — a multiple-time IBJJF World Champion and ADCC Champion, and founder and head coach of Atos Jiu-Jitsu. For the first time ever, he brings his seminar to the Netherlands, hosted by Best of the Best BJJ.',
    galvao_career_title: 'Career Highlights',
    galvao_career_text: 'From his first black belt world title to becoming one of the most dominant no-gi competitors of his generation, André Galvão has built a career spanning IBJJF, ADCC and professional MMA. As founder and head coach of Atos Jiu-Jitsu, he has developed dozens of world champions — cementing his legacy both on the mat and as a leader of the sport.',
    ...
    galvao_tickets_pending: 'Ticket widget is being connected — check back shortly.',
  ...
  nl: {
    ...
    galvao_about_text: 'André Galvão is een van de meest gelauwerde atleten in de geschiedenis van het Braziliaans Jiu-Jitsu — meervoudig IBJJF World Champion en ADCC Champion, en oprichter en hoofdtrainer van Atos Jiu-Jitsu. Voor het eerst ooit brengt hij zijn seminar naar Nederland, georganiseerd door Best of the Best BJJ.',
    galvao_career_title: 'Carrièrehoogtepunten',
    galvao_career_text: 'Van zijn eerste wereldtitel als zwarte band tot een van de meest dominante no-gi atleten van zijn generatie — André Galvão bouwde een carrière die IBJJF, ADCC en professioneel MMA overspant. Als oprichter en hoofdtrainer van Atos Jiu-Jitsu leidde hij tientallen wereldkampioenen op en bevestigde zo zijn legacy, zowel op de mat als als leider binnen de sport.',
    galvao_tickets_title: 'Tickets',
    ...
    galvao_tickets_provider: 'Tickets via Weeztix',
    galvao_tickets_pending: 'De ticketwidget wordt binnenkort gekoppeld — kom snel terug.',
  ...
  fr: {
    ...
    galvao_about_text: 'André Galvão est l\'un des compétiteurs les plus titrés de l\'histoire du Jiu-Jitsu brésilien — plusieurs fois champion du monde IBJJF et champion ADCC, fondateur et entraîneur en chef d\'Atos Jiu-Jitsu. Pour la première fois, il organise son séminaire aux Pays-Bas, présenté par Best of the Best BJJ.',
    galvao_career_title: 'Faits Marquants de Carrière',
    galvao_career_text: 'De son premier titre mondial en ceinture noire à devenir l\'un des compétiteurs no-gi les plus dominants de sa génération, André Galvão a construit une carrière qui s\'étend à l\'IBJJF, l\'ADCC et au MMA professionnel. En tant que fondateur et entraîneur en chef d\'Atos Jiu-Jitsu, il a formé des dizaines de champions du monde, consolidant son héritage sur le tapis comme en tant que leader du sport.',
    ...
    galvao_tickets_pending: 'Le widget de billetterie est en cours de connexion — revenez bientôt.',
    galvao_sponsors_title: 'Sponsors',
  ...
  de: {
    ...
    galvao_about_text: 'André Galvão ist einer der erfolgreichsten Wettkämpfer in der Geschichte des Brazilian Jiu-Jitsu — mehrfacher IBJJF World Champion und ADCC Champion sowie Gründer und Cheftrainer von Atos Jiu-Jitsu. Zum ersten Mal bringt er sein Seminar in die Niederlande, veranstaltet von Best of the Best BJJ.',
    galvao_career_title: 'Karriere-Highlights',
    galvao_career_text: 'Von seinem ersten Weltmeistertitel als Schwarzgurt bis hin zu einem der dominantesten No-Gi-Athleten seiner Generation — André Galvão hat eine Karriere aufgebaut, die IBJJF, ADCC und professionelles MMA umfasst. Als Gründer und Cheftrainer von Atos Jiu-Jitsu hat er Dutzende Weltmeister ausgebildet und damit sein Vermächtnis sowohl auf der Matte als auch als Anführer des Sports gefestigt.',
    galvao_tickets_title: 'Tickets',
    ...
    galvao_tickets_pending: 'Das Ticket-Widget wird gerade angebunden — schau bald wieder vorbei.',
    galvao_sponsors_title: 'Sponsoren',

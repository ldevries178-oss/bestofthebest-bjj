    ...
    <div className="h-[100dvh] w-full text-white flex flex-col items-center justify-center relative overflow-hidden font-sans">
      ...
      <main className="relative z-10 flex flex-col items-center justify-center gap-5 md:gap-8 w-full h-full max-h-[950px] max-w-3xl px-4 text-center py-6 md:py-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 gap-2 md:gap-4 w-full max-w-[800px] px-2 sm:px-4 z-20 mt-2">
          ...
          <Link to="/sponsors" className="neon-button-ref col-span-1 flex items-center justify-center w-full h-auto py-3 font-orbitron font-semibold text-[10px] sm:text-xs xl:text-sm tracking-wider md:tracking-widest rounded-lg whitespace-normal px-1 sm:px-6 text-center">
            {t('navSponsors') || "Sponsors"}
          </Link>
          <Link to="/contact" className="neon-button-ref col-span-2 md:col-span-2 md:justify-self-center flex items-center justify-center w-full md:w-[380px] h-auto py-3 font-orbitron font-semibold text-[11px] sm:text-xs xl:text-sm tracking-wider md:tracking-widest rounded-lg whitespace-normal px-2 sm:px-6 text-center">

...
function SocialIcons() {
  return (
    <div className="fixed top-0 left-0 p-4 md:p-6 z-[100] pointer-events-none">
      <nav className="flex gap-2 items-center pointer-events-auto">
        {/* Instagram */}
        <a
          href="https://www.instagram.com/bestofthebest_bjj/"
          target="_blank"
          rel="noopener noreferrer"
          className="social-icon-link w-10 h-10 flex items-center justify-center rounded-lg border border-white/10 bg-[#0a0a0f]/40 backdrop-blur-sm hover:border-synth-blue transition-all"
